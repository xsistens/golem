            ...
            for agent_type in agent_types {
                ...
                targets.push(BridgeSdkTarget {
                    ...
                    derive_rules: sdks_targets
                        ...
                        .unwrap_or_default(),
                    generate_param_conversions: sdks_targets
    ...
    for component_name in ctx.application_context().selected_component_names() {
        ...
        for agent_type in agent_types {
            ...
            targets.push(BridgeSdkTarget {
                ...
                generate_param_conversions: custom_target.generate_param_conversions,
            });
        }
    }
        ...
        .run_async_or_skip(
            || async {
                ...
                let config = BridgeGeneratorConfig {
                    ...
                    generate_param_conversions: target.generate_param_conversions,
                };
                let mut generator: Box<dyn BridgeGenerator> = match target.target_language {
                    ...
                    GuestLanguage::TypeScript => Box::new(
                        <TypeScriptBridgeGenerator as BridgeGenerator>::new(
                            target.agent_type,
                            &output_dir,
                            false,
                            config,
